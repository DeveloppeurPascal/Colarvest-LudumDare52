# Colarvest (Ludum Dare 52)

[Cette page en français.](LISEZMOI.md)

Colarvest was launched at the Ludum Dare 52 game jam in January 2023. Its theme was ‘Harvest’.

The aim of the game is to maintain plantations by planting and harvesting them before they rot.

This code repository contains a project developed in Object Pascal language under Delphi. You don't know what Delphi is and where to download it ? You'll learn more [on this web site](https://delphi-resources.developpeur-pascal.fr/).

## Using this video game

Visit [the Colarvest website](https://colarvest.gamolf.fr/) to download the compiled version, learn more about how it works, access videos and articles, find out about the different versions available and their features, contact user support...
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://github.com/DeveloppeurPascal/Colarvest-LudumDare52).

This project uses dependencies in the form of sub-modules. They will be absent from the ZIP file. You'll have to download them by hand.

* [digao-dalpiaz/DzHTMLText](https://github.com/digao-dalpiaz/DzHTMLText) must be installed in the ./Libraries/DzHTMLText subfolder.
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://github.com/DeveloppeurPascal/Colarvest-LudumDare52/issues) so that I can test and try to correct or provide a workaround.
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://github.com/DeveloppeurPascal/Colarvest-LudumDare52) and [open a new issue](https://github.com/DeveloppeurPascal/Colarvest-LudumDare52/issues).
